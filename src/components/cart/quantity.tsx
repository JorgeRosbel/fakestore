...
export const Quantity: React.FC<Quant> = ({id,amount}) => {
    ...
    return (
        <td id="--row-quantity" className="border-black dark:border-white border-opacity-20 dark:border-opacity-20 w-[100px]  border-solid border-b-[2px] text-center">
